...
import com.apps.projectakhir.juanlazuardo.model.UserModel;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void validasiRegister(){
        ...
        if (TextUtils.isEmpty(userName)){
            edtUserName.setError("Username Kosong,Harus diisi");
            fokus = edtUserName;
            cancel = true;
        ...
        if (TextUtils.isEmpty(password)){
            edtPassWord.setError("Password Kosong, Harus Diisi");
            fokus = edtPassWord;
            cancel = true;
